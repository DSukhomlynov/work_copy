 ...
 */
class SubscriptionController extends AppAdminController
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            if($model->image) {
                $model->image = Yii::$app->basePath."/web".$model->image;
                $model->upload_image();
            }
            unset($model->image);
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            if(!empty($model->image) && $model->image != $this->findModel($id)->getImage()->filePath){
                $model->image = Yii::$app->basePath."/web".$model->image;
